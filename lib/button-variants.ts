...
/**
 * Shared button variant styles — importable from both Server and Client components.
 * Keep this file free of "use client" so server components can use buttonVariants.
 */
